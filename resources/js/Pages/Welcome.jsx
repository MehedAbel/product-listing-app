...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="bg-gray-50 text-black/50 dark:bg-zinc-800 dark:text-white/50 flex flex-col min-h-screen">
                <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-[rgb(255,45,32)] selection:text-white">
                    <div className="relative w-full min-h-screen flex flex-col">
                        ...
                        <main className="mt-6 px-6 flex flex-col justify-center items-center flex-1">
                            <h1>Home</h1>
                        </main>
